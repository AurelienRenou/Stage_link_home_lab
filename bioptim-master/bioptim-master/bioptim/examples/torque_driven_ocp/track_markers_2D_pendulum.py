...
spec = importlib.util.spec_from_file_location(
    "data_to_track", str(EXAMPLES_FOLDER) + "/getting_started/pendulum_with_contact_y.py"
)
...
def main():
    """
    Firstly, it solves the getting_started/pendulum_with_contact_y.py example. Afterward, it gets the marker positions and joint
