...
def test__getting_started__custom_plotting():
    ...
    ocp_module.prepare_ocp(
        biorbd_model_path=bioptim_folder + "/models/pendulum.bioMod", final_time=2, n_shooting=50,
    )
...
def test__getting_started__example_save_and_load():
    ...
    ocp_module.prepare_ocp(
        biorbd_model_path=bioptim_folder + "/models/pendulum.bioMod", final_time=3, n_shooting=100, n_threads=4,
    )
...
def test__getting_started__pendulum():
    ...
    ocp_module.prepare_ocp(
        biorbd_model_path=bioptim_folder + "/models/pendulum.bioMod", final_time=3, n_shooting=100,
    )
...
def test__muscle_driven_ocp__static_arm():
    ...
    ocp_module.prepare_ocp(
        biorbd_model_path=bioptim_folder + "/models/arm26.bioMod", final_time=3, n_shooting=50, weight=1000,
    )
...
def test__symmetrical_torque_driven_ocp__symmetry_by_constraint():
    ...
    ocp_module.prepare_ocp(biorbd_model_path=bioptim_folder + "/models/cubeSym.bioMod",)
...
def test__torque_driven_ocp__track_markers_with_torque_actuators():
    ...
    ocp_module.prepare_ocp(
        biorbd_model_path=bioptim_folder + "/models/cube.bioMod", n_shooting=30, final_time=2, actuator_type=1,
    )
...
def test__torque_driven_ocp__trampo_quaternions():
    ...
    ocp_module.prepare_ocp(
        biorbd_model_path=bioptim_folder + "/models/TruncAnd2Arm_Quaternion.bioMod", n_shooting=5, final_time=0.25,
    )
...
def test__track__track_segment_on_rt():
    ...
    ocp_module.prepare_ocp(
        biorbd_model_path=bioptim_folder + "/models/cube_and_line.bioMod", n_shooting=30, final_time=1,
    )
