...
def test_acados_no_obj(cost_type):
    ...
    ocp = ocp_module.prepare_ocp(biorbd_model_path=bioptim_folder + "/models/cube.bioMod", n_shooting=10, tf=2,)
...
def test_acados_one_lagrange(cost_type):
    ...
    ocp = ocp_module.prepare_ocp(biorbd_model_path=bioptim_folder + "/models/cube.bioMod", n_shooting=n_shooting, tf=2,)
    objective_functions = ObjectiveList()
...
def test_acados_options(cost_type):
    ...
    ocp = ocp_module.prepare_ocp(
        biorbd_model_path=bioptim_folder + "/models/pendulum.bioMod", final_time=0.6, n_shooting=200,
    )
...
def test_acados_fail_external():
    ...
    ocp = ocp_module.prepare_ocp(
        biorbd_model_path=bioptim_folder + "/models/pendulum.bioMod", final_time=1, n_shooting=2,
    )
...
def test_acados_fail_lls():
    ...
    ocp = ocp_module.prepare_ocp(
        biorbd_model_path=bioptim_folder + "/models/arm26.bioMod", final_time=1, n_shooting=2, use_sx=True,
    )
