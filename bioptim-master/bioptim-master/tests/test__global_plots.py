...
def test_plot_graphs_one_phase():
    ...
    ocp = ocp_module.prepare_ocp(biorbd_model_path=bioptim_folder + "/models/cube.bioMod", n_shooting=30, final_time=2,)
...
def test_add_new_plot():
    ...
    ocp = ocp_module.prepare_ocp(
        biorbd_model_path=bioptim_folder + "/models/cube.bioMod", n_shooting=20, final_time=0.5,
    )
    solver = Solver.IPOPT()
