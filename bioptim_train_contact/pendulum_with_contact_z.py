...
def prepare_ocp(
    ...
    x_bounds[:, [0, -1]] = 0
    x_bounds[2, -1] = 3.14  # We have added a dof, translation z, so now rotation x is the third component
    x_bounds.min[3:, 1] = -600
    x_bounds.max[3:, 1] = 600
    ...
    tau_min, tau_max, tau_init = -1000, 1000, 0  # we rise up the bounds
    u_bounds = Bounds([tau_min] * n_tau, [tau_max] * n_tau)
    u_bounds[[0, 1], :] = 0  # Prevent the model from actively transpose along y and z
